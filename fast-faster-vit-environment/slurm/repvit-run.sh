...
#SBATCH -n 25
#SBATCH --mem=12g
#SBATCH -J "SIIM-ACR Pneumothorax RepViT (Tentative)"
#SBATCH -p long
#SBATCH -t 2-23:00:00
#SBATCH --gres=gpu:2
...
python3 pytorch_executor.py -m repvit_m1 -e 25 -p data/siim-acr-pneumothorax
python3 pytorch_executor.py -m repvit_m1 -um -e 25 -p data/siim-acr-pneumothorax